...
const messages: Record<Locale, Record<string, string>> = {
  es: {
    ...
    "email.appStatus.subject": "Actualización de tu postulación — SEMBER CONNECT",
    "email.appStatus.greeting": "Hola {{name}},",
    "email.appStatus.body": "El estado de tu postulación a «{{opportunity}}» en {{organization}} cambió a:",
    "email.appStatus.noteLabel": "Mensaje del reclutador:",
    "email.appStatus.cta": "Ingresa a tu perfil en SEMBER CONNECT para ver el detalle de tu proceso.",
    "email.appStatus.ignore": "Recibes este correo porque tienes una postulación activa en SEMBER CONNECT.",
    "email.appStatus.label.enviada": "Recibida",
    "email.appStatus.label.en_revision": "En revisión",
    "email.appStatus.label.preseleccionado": "Preseleccionado",
    "email.appStatus.label.entrevista": "Entrevista",
    "email.appStatus.label.aceptado": "Aceptado",
    "email.appStatus.label.rechazado": "Rechazado",
  },
  en: {
    // auth routes
    ...
    "email.appStatus.subject": "Update on your application — SEMBER CONNECT",
    "email.appStatus.greeting": "Hi {{name}},",
    "email.appStatus.body": "The status of your application to “{{opportunity}}” at {{organization}} changed to:",
    "email.appStatus.noteLabel": "Message from the recruiter:",
    "email.appStatus.cta": "Sign in to your SEMBER CONNECT profile to see the details of your process.",
    "email.appStatus.ignore": "You are receiving this email because you have an active application on SEMBER CONNECT.",
    "email.appStatus.label.enviada": "Received",
    "email.appStatus.label.en_revision": "Under review",
    "email.appStatus.label.preseleccionado": "Shortlisted",
    "email.appStatus.label.entrevista": "Interview",
    "email.appStatus.label.aceptado": "Accepted",
    "email.appStatus.label.rechazado": "Rejected",
  },
  pt: {
    // auth routes
    ...
    "email.appStatus.subject": "Atualização da sua candidatura — SEMBER CONNECT",
    "email.appStatus.greeting": "Olá {{name}},",
    "email.appStatus.body": "O status da sua candidatura para «{{opportunity}}» na {{organization}} mudou para:",
    "email.appStatus.noteLabel": "Mensagem do recrutador:",
    "email.appStatus.cta": "Acesse seu perfil na SEMBER CONNECT para ver os detalhes do seu processo.",
    "email.appStatus.ignore": "Você recebe este e-mail porque tem uma candidatura ativa na SEMBER CONNECT.",
    "email.appStatus.label.enviada": "Recebida",
    "email.appStatus.label.en_revision": "Em análise",
    "email.appStatus.label.preseleccionado": "Pré-selecionado",
    "email.appStatus.label.entrevista": "Entrevista",
    "email.appStatus.label.aceptado": "Aceito",
    "email.appStatus.label.rechazado": "Rejeitado",
  },
};
